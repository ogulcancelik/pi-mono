/**
 * Diacritics used to encode row/column indices for Kitty Unicode image placeholders.
 * Derived from UnicodeData.txt combining class 230 characters (above the base character)
 * that do not have decomposition mappings and won't be fused during normalization.
 *
 ...
 */
// prettier-ignore
export const PLACEHOLDER_DIACRITICS = [
